...
namespace umbraco.presentation.LiveEditing.Controls
{
    ...
    public class LiveEditingToolbar : Control
    {
        ...
        /// 
        /// <param name="preview">Refresh in preview mode</param>
        /// </summary>

        protected virtual void RefreshPage(bool preview)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(Page, GetType(), new Guid().ToString(),
                String.Format("window.setTimeout(window.location.href='{0}{1}',10000);", url, preview ? "?preview=please" : ""), true);
        }
