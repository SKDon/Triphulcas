<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRelationType.aspx.cs" Inherits="Umbraco.RelationTypes.EditRelationType" MasterPageFile="/umbraco/masterpages/umbracoPage.Master" %>
...
<asp:Content ID="headContent" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        /* direction icons */
        table.relations td.parentToChild { background-image: url('/umbraco/plugins/RelationTypes/Images/ParentToChild.png'); }
        table.relations td.bidirectional { background-image: url('/umbraco/plugins/RelationTypes/Images/Bidirectional.png');}        
    </style>  
